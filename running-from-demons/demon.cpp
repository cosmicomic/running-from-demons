...
void Demon::interact(Player *player, Location *street, Location *bedroom) {
    if (type == "self-loathing"){
        interactSelfLoathing(player, street);
...
void Demon::interactRegret(Player *player) {
    ...
    cout << "..."; 
    getEnter();
    cout << "You wake up bound to a chair in the theatre. "
    << "Your eyelids are held open by a crude metal instrument."; getEnter();
    cout << endl << "The film begins. As the images flash before your eyes, you are seized with an overwhelming sense of nausea. You feel sick to your stomach. "
    ...
    << "they are shrivelling up. You scream in pain and horror until you once again lose consciousness."; getEnter();
...
void Demon::interactDespair(Player *player) {
    ...
    getEnter();
    cout << endl << "First, it slashes at your arm. Then your stomach. Then your thigh. Blood blossoms out and drips to the ground. "
    ...
    getEnter();
    cout << endl << "The demon is satisfied. It leaves you collapsed on the ground, a writhing, agonized wretch, hardly able to muster the effort to groan in pain.";
    getEnter();
    player->setHealth(player->getHealth() - STARTING_HEALTH/2);
}
...
void Demon::interactDistraction(Player *player, Location *bedroom) {
    ...
    << " Soon enough, the tension releases, and you are plopped onto the beige carpet of your bedroom." << endl;
...
void Demon::interactSelfLoathing(Player *player, Location *location) {
    ...
    getEnter();
    cout << endl << "You carve a thick, red line across your stomach. Green and red fluids, as well as bile, leaks out. "
    ...
    getEnter();
    cout << endl << "You lose consciousness and wake up sprawled on the cold, cracked asphalt of the street in front of your apartment building.";
    getEnter();
    cout << endl << "Peeking under your shirt, you find that the cuts have been sloppily stitched up.";
    player->setHealth(player->getHealth() - STARTING_HEALTH/2);
